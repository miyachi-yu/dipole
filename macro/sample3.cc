/*
  sample macro:
  Fit ESR data with Asymmetric Gaussian translated with Dipole Kernel
 */
int sample3(){
  ...
  f1->SetParameter( 0, 147 );
  f1->SetParameter( 1, 1.03 );
  f1->SetParameter( 2, 0.143 );
  f1->SetParameter( 3, 2.72 );
